...
public class Combiners {
	public static void main(String[] args) throws Exception{
	    ...
	    job.setMapperClass(CombinersMap.class);
	    job.setCombinerClass(CombinersReduce.class);
	    job.setReducerClass(CombinersReduce.class);
...
class CombinersMap extends Mapper<LongWritable, Text, Text, DoubleWritable>{
	Text word = new Text();
...
class CombinersReduce extends Reducer<Text, DoubleWritable, Text, DoubleWritable>{
